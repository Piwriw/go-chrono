...
// CronJob represents a jobs that runs based on a cron expression.
...
//
//	*CronJob - The CronJob for method chaining / 支持链式调用的 CronJob
func (c *CronJob) Watch(watch func(event common.JobWatchInterface)) *CronJob {
	c.WatchFunc = watch
	return c
}
