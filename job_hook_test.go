...
// TestDefaultBeforeJobRuns tests the default before job runs hook.
...
func TestDefaultBeforeJobRuns(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			jobName:   "test-job-with-special-chars-中文",
			wantPanic: false,
		},
	}
...
// TestDefaultBeforeJobRunsSkipIfBeforeFuncErrors tests the skippable before job runs hook.
...
func TestDefaultBeforeJobRunsSkipIfBeforeFuncErrors(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "Valid job ID and name returns nil",
			jobID:       uuid.MustParse("00000000-0000-0000-0000-000000000001"),
			jobName:     "test-job",
			wantErr:     false,
			expectedErr: nil,
		...
		{
			name:        "Empty job name returns nil",
			jobID:       uuid.MustParse("00000000-0000-0000-0000-000000000002"),
			jobName:     "",
			wantErr:     false,
			expectedErr: nil,
		...
		{
			name:        "Long job name returns nil",
			jobID:       uuid.MustParse("00000000-0000-0000-0000-000000000003"),
			jobName:     "this-is-a-very-long-job-name-with-lots-of-characters",
			wantErr:     false,
			expectedErr: nil,
		},
	}
...
// TestDefaultAfterJobRuns tests the default after job runs hook.
...
// TestDefaultAfterJobRunsWithError tests the default after job runs with error hook.
...
// TestDefaultAfterJobRunsWithPanic tests the default after job runs with panic hook.
