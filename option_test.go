...
func TestAliasOption(t *testing.T) {
	...
	tests := []struct {
		...
		option *AliasOption        // 要测试的选项 / Option to test
		setup  func() *AliasOption // 设置函数 / Setup function
	}{
		{
		...
		},
		{
			...
			option: &AliasOption{enabled: true},
		},
		{
			name: "alias option created with WithAliasMode",
			setup: func() *AliasOption {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			// Test Name method
			// 测试 Name 方法
			assert.Equal(t, AliasOptionName, tt.option.Name(), "Name should return AliasOptionName")
			...
			// 验证接口实现
			var _ ScheduleOption = tt.option
		})
	}
}
...
func TestWatchOption(t *testing.T) {
	...
	customWatchFunc := func(event JobWatchInterface) {
		// Custom watch function
	}

	tests := []struct {
		name     string              // 测试用例名称 / Test case name
		option   *WatchOption        // 要测试的选项 / Option to test
		setup    func() *WatchOption // 设置函数 / Setup function
		...
		},
		{
			...
			option:   &WatchOption{enabled: true, watchFunc: customWatchFunc},
			wantFunc: true,
		},
		{
			name: "watch option created with WithWatch and custom function",
			setup: func() *WatchOption {
				schOpts := &SchedulerOptions{}
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			// Test Name method
			// 测试 Name 方法
			assert.Equal(t, WatchOptionName, tt.option.Name(), "Name should return WatchOptionName")
...
func TestWebMonitorOption(t *testing.T) {
	...
	tests := []struct {
		name     string                   // 测试用例名称 / Test case name
		option   *WebMonitorOption        // 要测试的选项 / Option to test
		setup    func() *WebMonitorOption // 设置函数 / Setup function
		...
		},
		{
			...
			option:   &WebMonitorOption{enabled: true, address: "localhost:8080"},
			wantAddr: "localhost:8080",
		},
		{
			name: "web monitor option created with WithWebMonitor",
			setup: func() *WebMonitorOption {
				schOpts := &SchedulerOptions{}
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			// Test Name method
			// 测试 Name 方法
			assert.Equal(t, WebMonitorOptionName, tt.option.Name(), "Name should return WebMonitorOptionName")
...
func TestLimitOption(t *testing.T) {
	...
	tests := []struct {
		name      string              // 测试用例名称 / Test case name
		option    *LimitOption        // 要测试的选项 / Option to test
		setup     func() *LimitOption // 设置函数 / Setup function
		...
		},
		{
			...
			option:    &LimitOption{enabled: true, number: 100},
			wantLimit: 100,
		},
		{
			name: "limit option created with WithLimit",
			setup: func() *LimitOption {
				schOpts := &SchedulerOptions{}
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			// Test Name method
			// 测试 Name 方法
			assert.Equal(t, LimitOptionName, tt.option.Name(), "Name should return LimitOptionName")
...
func TestPrometheusOption(t *testing.T) {
	...
	tests := []struct {
		name     string                   // 测试用例名称 / Test case name
		option   *PrometheusOption        // 要测试的选项 / Option to test
		setup    func() *PrometheusOption // 设置函数 / Setup function
		wantAddr string                   // 预期地址 / Expected address
	}{
		{
		...
		},
		{
			...
			option:   &PrometheusOption{enabled: true, address: ":9090"},
			wantAddr: ":9090",
		},
		{
			name: "prometheus option created with WithPrometheus",
			setup: func() *PrometheusOption {
				schOpts := &SchedulerOptions{}
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			// Test Name method
			// 测试 Name 方法
			assert.Equal(t, PrometheusOptionName, tt.option.Name(), "Name should return PrometheusOptionName")
